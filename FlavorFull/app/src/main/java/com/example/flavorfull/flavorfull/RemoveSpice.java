...
public class RemoveSpice extends AppCompatActivity {
...
*/
        ...
        addSpice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean addSpice = person.removeSspice(spinner.getSelectedItem().toString());
                if (addSpice) {
                    Toast.makeText(RemoveSpice.this, "Spice added!",
                            Toast.LENGTH_SHORT).show();
                    Intent return_main = new Intent(RemoveSpice.this, MainActivity.class);
                    startActivity(return_main);
                }

                else {
                    Toast.makeText(RemoveSpice.this, "That spice is not in the inventory!",
                            Toast.LENGTH_SHORT).show();
                }
